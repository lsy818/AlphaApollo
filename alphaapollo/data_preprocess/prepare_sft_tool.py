...
Example usage::
    ...
    python -m alphaapollo.data_preprocess.prepare_sft_tool \
...
def process_example(
    ...
    *,
    ...
    record = {
        "messages": prompt + [{"role": "assistant", "content": gt_traj}]
    }
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="HuggingFace dataset repository ID (default: openai/gsm8k).",
    )
    parser.add_argument(
        "--splits",
        default="train,test",
